...
def build():
    ...
    slide_fig(
        ...
        "그림 7. 심사자 화면. 복셀별 검출확률을 명도로, 카메라 위치와 화각을 "
        "부채꼴로 표시한다. 짙을수록 못 보는 곳이다.",
        "§5 적용성",
        "PT 승부처. 지면에서는 3D 한 장만 쓰고 2D/2.5D 전환은 발표에서 보인다. "
        "원본 램프는 붉은색↔푸른색 발산인데, 그대로 회색조로 낮추면 양끝 명도가 "
        "비슷해져 구별이 사라지므로 명도를 단조로 다시 깔았다.",
    ...
    slide_fig(
        prs, "9", "시간대별 위험구역 진단", "fig_timephase.png",
        ...
        "옮기는 4D 최적화와는 축이 다르다. 목업에는 시간대 화면이 없어 "
        "보고서 7절을 오려 썼다.",
        "선택 · 그림 8 안에도 같은 내용이 있다. 둘 중 하나만 써도 된다")
